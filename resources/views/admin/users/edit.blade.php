...
@section('content')
        ...
        <div style="display: flex;flex-direction: row; gap: 100px; margin-bottom:100px">
            ...
            <div style="">
                ...
                <div>
                    Email : 
                    <input id="name" value="{{$user->email}}" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                </div><br>
