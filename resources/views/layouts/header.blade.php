<div style="margin-top: 0%; margin-left: 0%; position: fixed; width: 100%; top:0">
    <div class="" style="background-color: #1742a4; height: 70px">
        <ul class="nav" style="margin-left: 0px;"> 
            ...
            <li class="nav-item dropdown" style="color:white; margin-top: 20px; margin-left:150px; ">
            ...
            @auth
                <li class="nav-item" >
                    <a style="color:white; margin-top: 20px; margin-left: 30px" class="nav-link" href="#">Mes formations</a>
                </li>
            ...
            @else
                <li class="nav-item" >
                    <a style="color:white; margin-top: 15px; margin-left: 150px" href="{{ route('login') }}" class="nav-link"><button type="button" class="btn btn-primary">Sign in</button></a>
                </li>
                <li class="nav-item" >
